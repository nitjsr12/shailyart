...
export const paintings: Painting[] = [
  ...
  {
    id: 19,
    slug: "lord-ganesha-abstract-large",
    title: "Lord Ganesha Abstract",
    category: "Devotional",
    image: "/assets/ganesha-abstract.png",
    description: "A vibrant, modern abstract painting of Lord Ganesha in bold blues, reds, and gold. A striking piece for contemporary homes.",
    details: "This expressive acrylic painting combines traditional devotion with a contemporary abstract style. Bold brushstrokes and a rich color palette make it a standout piece for any living space. Offered in a large canvas format.",
    medium: "Acrylic on Canvas",
    year: "2025",
...
export const categories = ["All", "Abstract", "Portrait", "Devotional"];
